...
INSERT INTO t_system_config (id, config_key, config_value, config_type, scope, description, value_type, enabled, module, group_name, display_name, sort_order, created_by) VALUES
    ...
    ('00000000-0000-0000-0003-000000000100', 'runtime.billing.enabled_payment_providers',  'STRIPE,WECHATPAY', 'FEATURE', 'GLOBAL', '启用的支付渠道（逗号分隔，可选: STRIPE/WECHATPAY/ALIPAY）', 'STRING',  TRUE, 'billing', 'payment', '启用的支付渠道',       333, '00000000-0000-0000-0000-000000000000'),
    -- AI 模块 - rate_limit
